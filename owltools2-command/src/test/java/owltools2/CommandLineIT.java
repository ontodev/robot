...
public class CommandLineIT {
     ...
     */
    private String execPath = "../bin/owltools2";
    ...
    /**
     * Extract all the owltools2 commands from the example README file.
    ...
    /**
     * Given a command string starting with 'owltools2',
     * run that command using the bin/owltools2 script
