...
public class MirrorOperationTest extends CoreTest  {
     ...
     */
    @Test
    public void testMirror() throws IOException, OWLOntologyCreationException,
            OWLOntologyStorageException {
        testMirror("/import_test.owl");
    }

    /**
     * Mirrors a given ontology plus its import closure, and tests the results
     * are identical when loaded.
     *
    ...
    public void testMirror(String expectedPath)
        ...
        OWLOntology loadedOntology = loadOntologyWithCatalog(
                inputOntology.getOntologyID().getOntologyIRI().get(),
                catalogFile);
        ...
        for (OWLOntology importedOntology : inputOntology.getImportsClosure()) {
            ...
            for (OWLOntology loadedImportedOntology
                    : loadedOntology.getImportsClosure()) {
                if (loadedImportedOntology.getOntologyID().equals(
                        importedOntology.getOntologyID())) {
