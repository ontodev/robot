...
public class RelatedEntitiesHelper {
    ...
    /**
     * Convenience method to return named classes for a given relation. 
     * Does not include anonymous classes.
     * 
     ...
     */
    public static Set<OWLClass> getRelatedClasses(OWLOntology ontology, IRI iri, String relationOption) {
     ...
     */
    public static Set<OWLObject> getRelatedEntities(OWLOntology ontology, IRI iri, String relationOption, boolean excludeAnonymous) {
     ...
     * @return Set of OWLObjects
     */
    public static Set<OWLObject> getRelatedEntities(OWLOntology ontology, Set<IRI> IRIs, String relationOption, boolean excludeAnonymous) {
    	return getRelatedEntities(ontology, IRIs, Arrays.asList(relationOption), excludeAnonymous);
    }
     ...
     * @param  ontology OWLOntology to retrieve entities from
     * @param  iri IRI to retrieve related entities of
     * @param  relationOptions List of string options specifying what types of related entities to retrieve
     * @param  excludeAnonymous if true, do not include any anonymous classes
     * @return Set of OWLObjects
     */
    public static Set<OWLObject> getRelatedEntities(OWLOntology ontology, IRI iri, List<String> relationOptions, boolean excludeAnonymous) {
    	Set<IRI> IRIs = Sets.newHashSet(iri);
	...
	public static Set<OWLObject> getRelatedEntities(OWLOntology ontology,
			Set<IRI> IRIs, List<String> relationOptions, boolean excludeAnonymous) {
		...
		for (String opt : relationOptions) {
			if ("ancestors".equals(opt.toLowerCase())) {
				relatedEntities.addAll(
						getAncestors(ontology, entitiesByType, excludeAnonymous));
			} else if ("descendants".equals(opt.toLowerCase())) {
				relatedEntities.addAll(
						getDescendants(ontology, entitiesByType, excludeAnonymous));
			} else if ("equivalents".equals(opt.toLowerCase())) {
				relatedEntities.addAll(
						getEquivalents(ontology, entitiesByType, excludeAnonymous));
			} else if ("disjoints".equals(opt.toLowerCase())) {
				relatedEntities.addAll(
						getDisjoints(ontology, entitiesByType, excludeAnonymous));
	...
	private static Set<OWLObject> getAncestors(OWLOntology ontology,
			Map<EntityType<?>, Set<OWLEntity>> entitiesByType, boolean excludeAnonymous) {
	...
	private static void getAncestors(OWLOntology ontology, OWLClass cls,
			Set<OWLObject> ancestors, boolean excludeAnonymous) {
	 ...
	 * @param ancestors Set of OWLObjects representing the ancestors
	 */
	private static void getAncestors(OWLOntology ontology, OWLDataProperty dataProperty, Set<OWLObject> ancestors) {
	 ...
	 * @param ancestors Set of OWLObjects representing the ancestors
	 */
	private static void getAncestors(OWLOntology ontology, OWLObjectProperty objectProperty, Set<OWLObject> ancestors) {
	...
	private static void getDescendants(OWLOntology ontology, OWLClass cls,
			Set<OWLObject> descendants, boolean excludeAnonymous) {
		Set<OWLSubClassOfAxiom> axioms =
	...
	private static void getDisjoints(OWLOntology ontology, OWLClass cls,
			Set<OWLObject> disjoints, boolean excludeAnonymous) {
	...
	private static void getEquivalents(OWLOntology ontology, OWLClass cls,
			Set<OWLObject> equivalents, boolean excludeAnonymous) {
