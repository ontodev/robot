...
public class ProtegeExplanationOrderer implements ExplanationOrderer {
  ...
  private void buildIndices() {
    ...
    try {
      ...
      ont =
          man.createOntology(
              IRI.create(
                  "http://www.semanticweb.org/", "ontology" + randomstart.incrementAndGet()));
  ...
  private static PropertiesFirstComparator propertiesFirstComparator =
