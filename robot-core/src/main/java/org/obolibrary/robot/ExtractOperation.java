 ...
 * Uses the OWLAPI's SyntacticLocalityModuleExtractor (SLME).
 *
...
public class ExtractOperation {
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(ExtractOperation.class);
    ...
    public static OWLOntology extract(OWLOntology inputOntology,
            Set<IRI> terms, IRI outputIRI, ModuleType moduleType)
