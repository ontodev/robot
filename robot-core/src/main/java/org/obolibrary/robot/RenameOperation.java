...
public class RenameOperation {
   ...
   * @param allowMissingEntities if true, command will fail when an entity is in the rename map, but does not appear in ontology
   * @throws Exception if the old IRI in a mapping does not exist
   */
  public static void renameFull(
      OWLOntology ontology, IOHelper ioHelper, Map<String, String> mappings, boolean allowMissingEntities) throws Exception {
