...
public class MergeOperation {
     ...
     * add all the axioms from the source ontology and its import closure
     ...
     */
    public static void mergeInto(OWLOntology ontology,
     ...
     * for all the available merge options.
     *
