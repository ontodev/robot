...
public class UnmergeCommand implements Command {
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(UnmergeCommand.class);
    ...
    public String getUsage() {
        return "robot unmerge --input <file> "
             + "--input <file> "
             + "--output <file>";
    }
     ...
     * unmerge all ontology axioms into the first ontology
     * and return a state with the unmerged ontology.
     *
