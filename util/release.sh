...
| sed "s/[][]//g" \
> RELEASE.md
gh release create "v${VERSION}" --draft --notes-file RELEASE.md robot.jar
echo "  https://github.com/ontodev/robot/releases/tag/v${VERSION}"

echo "Stopping here for 1.7.1 release"
exit 0
